...
function cambiarEstadoInf(hr,estado){

var div_estadoInf;
		div_estadoInf=document.getElementById("div_estadoInf"+hr);			
		ajax=nuevoAjax();
		ajax.open("GET",'cambiarEstadoInf.php?hr='+hr+'&estado='+estado,true);					
		ajax.onreadystatechange=function(){
			if (ajax.readyState==4) {
			div_estadoInf.innerHTML=ajax.responseText;
		    }
	    }		
		ajax.send(null)	
...
?>
<h3 align="center" style="background:#FFF;font-size: 14px;color: #E78611;font-weight:bold;">LISTADO DE HOJAS DE RUTA </h3>
...
<tr class="texto">
         <td align="left" ><strong>Estado de Pago</strong></td>
